      ...
      <div class="pt-1 pb-3 px-3">
        ...
        >
          <Card
            ...
            :card="card"
            @card-deleted="
              $emit('card-deleted', { ...$event, listId: list.id })
            "
            @card-updated="
              $emit('card-updated', { ...$event, listId: list.id })
            "
          ></Card>
        </draggable>
        <CardAddEditor
...
export default {
  ...
  methods: {
    ...
    onMove({ relatedContext, draggedContext }) {
      ...
      this.cardUpdatePlacement(
        draggedContext.element.id,
        relatedContext.element.list.id,
        order
      );
    },
  },
