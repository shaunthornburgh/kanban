    ...
    <div>
        <li v-if="!editing">
            <a href="#" class="block p-5 rounded-md shadow bg-white relative hover:bg-gray-50 group">
                ...
                <div class="flex font-bold absolute top-0 right-0 p-1 text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity ease-out duration-500">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 hover:text-gray-700 pr-1" viewBox="0 0 20 20" fill="currentColor" @click="editing=true">
                        <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" />
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 hover:text-gray-700" viewBox="0 0 20 20" fill="currentColor" @click="cardDelete">
